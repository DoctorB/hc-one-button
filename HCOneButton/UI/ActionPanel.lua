...
HCOB.UI.ActionPanel.actions = {
    WARRIOR={S.REND,S.OVERPOWER,S.EXECUTE,S.HEROIC_STRIKE,S.SUNDER_ARMOR,S.THUNDER_CLAP,S.DEMO_SHOUT,S.BATTLE_SHOUT,S.BLOODRAGE,S.HAMSTRING,S.MORTAL_STRIKE,S.BLOODTHIRST,S.WHIRLWIND,S.PUMMEL,S.SHIELD_BASH,S.BERSERKER_RAGE,S.RETALIATION,S.SHIELD_WALL,S.CHARGE,S.CLEAVE},
    ...
    ROGUE={S.SINISTER_STRIKE,S.HEMORRHAGE,S.EVISCERATE,S.GOUGE,S.KICK,S.STEALTH,S.SPRINT,S.EVASION,S.VANISH,S.BLADE_FLURRY,S.SLICE_DICE,S.GARROTE,S.CHEAP_SHOT,S.KIDNEY_SHOT,S.BLIND,S.ADRENALINE_RUSH,S.RIPOSTE,S.AMBUSH},
...
function HCOB.UI.ActionPanel.BuildMacro(id)
    ...
    if id == S.HEROIC_STRIKE or id == S.CLEAVE then
        local queuedStrike = CastLine(id, "harm", true)
        return queuedStrike and ("/startattack [harm]\n" .. queuedStrike) or "/stopmacro"
    end
