...
HCOB.Data.Spells = HCOB.Data.Spells or {
    ...
    KICK=1766, SPRINT=2983, EVASION=5277, VANISH=1856, BLADE_FLURRY=13877, SLICE_DICE=5171, GARROTE=703, CHEAP_SHOT=1833, KIDNEY_SHOT=408, BLIND=2094, ADRENALINE_RUSH=13750, RIPOSTE=14251, AMBUSH=8676,
    ...
    -- Druid
    REGROWTH=8936, REJUVENATION=774,
