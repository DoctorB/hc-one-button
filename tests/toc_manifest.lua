...
assert(positions["Advisor/GroupHealing.lua"] < positions["UI/GroupHealing.lua"], "group triage must precede its secure UI")
assert(positions["Classes/Druid.lua"] < positions["UI/GroupHealing.lua"], "group bindings need all class contracts")
assert(positions["UI/GroupHealing.lua"] < positions["UI/GroupHealingPanel.lua"], "party grid needs group spell bindings")
assert(positions["UI/GroupHealingPanel.lua"] < positions["UI/GroupHealingOptions.lua"], "click configuration needs party grid")
assert(positions["UI/WindowManager.lua"] < positions["UI/GroupHealingOptions.lua"], "party options need managed navigation")
